    ...
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        ...
        <div className='lg:col-span-2 space-y-6'>
          {/* PERFORMANCE TREND CARD (COMPLETELY RESILIENT RECHARTS GRID LAYOUT FIXED) */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            {/* Changed parent layout to display: block layout fallback */}
            <div className='w-full block h-64 sm:h-72 relative'>
              {/* FIXED: Swapped width to 99% and set standard dynamic dimensions */}
